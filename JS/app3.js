    ...
    <div class="container">
        ...
        <button id="customColumnsBtn" class="custom-columns-btn">Customize Columns</button>
         <div class="download-options">
                <input type="number" id="downloadCount" min="1" max="1000" value="100" placeholder="Records">
                <button onclick="downloadData('excel')" class="btn btn-excel"><i class="fas fa-file-excel"></i> Excel</button>
                <button onclick="downloadData('csv')" class="btn btn-csv"><i class="fas fa-file-csv"></i> CSV</button>
                <button onclick="downloadData('pdf')" class="btn btn-pdf"><i class="fas fa-file-pdf"></i> PDF</button>
            </div>
